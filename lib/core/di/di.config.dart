...
import '../../features/customer/domain/usecases/create_customer.dart' as _i13;
...
_i1.GetIt $initGetIt(
  ...
  gh.lazySingleton<_i12.Validator>(() => _i12.Validator());
  gh.lazySingleton<_i13.CreateCustomer>(
      () => _i13.CreateCustomer(get<_i5.CustomerRepository>()));
  gh.factory<_i14.CreateCustomerCubit>(() =>
      _i14.CreateCustomerCubit(createCustomer: get<_i13.CreateCustomer>()));
  return get;
}
